 ...
 * 2014-05-05T23:31:50.776+01:00
 * Generated source version: 2.4.6
 * 
 */
@WebServiceClient(name = "TranslateService", 
                  wsdlLocation = "http://www.webservicex.net/TranslateService.asmx?WSDL",
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TranslateService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://www.webservicex.net/TranslateService.asmx?WSDL");
        }
        WSDL_LOCATION = url;
    }
